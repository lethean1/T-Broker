...
import transformers
from task.question_answering_trainer import CountShape as QuestionAnsweringTrainer
...
from task.question_answering_utils_qa import postprocess_qa_predictions
...
class DataTrainingArguments:
    ...
    dynamic_checkpoint: Optional[bool] = field(default=True, metadata={"help": "Use Dynamic Checkpoint for train speed and gpu memory"})
...
def main(raw_args=[]):
    ...
    print("[BertQA] Init parsers", flush=True)
  ...
  "--overwrite_output_dir", 
    ...
    print("[BertQA] parsing " + str(raw_args), flush=True)
    print("[BertQA] argsv is " + str(sys.argv), flush=True)
    model_args, data_args, training_args = parser.parse_args_into_dataclasses(raw_args, False, False)
    print("[BertQA] Done parsing", flush=True)
    ...
    print("[BertQA] Done copying", flush=True)
