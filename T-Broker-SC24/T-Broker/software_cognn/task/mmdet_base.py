...
from task.mmdet_train import train_detector
...
def get_cfg(args_str):
    ...
    meta['seed'] = args.seed
    meta['exp_name'] = osp.basename(args.config)
    return cfg, (distributed, args, timestamp, meta)
...
def mmdet_train(cfg, model, datasets, others):
    distributed, args, timestamp, meta, pipe = others
    train_detector(
        model,
        datasets,
        cfg,
