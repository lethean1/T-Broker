...
from task.MultipleChoice_trainer import CountShape as Trainer
...
def main(raw_args=[]):
  ...
  "--num_train_epochs", "1",
  "--do_train",
  "--per_device_train_batch_size", "16", "--overwrite_output_dir",
  "--memory_threshold", "30",
  "--memory_buffer", "0.5"
  ]
    
    model_args, data_args, training_args = parser.parse_args_into_dataclasses(raw_args)
